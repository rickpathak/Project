...
public class Accounts {
  ...
  public Accounts(int accountNo, String firstName, String lastName, String city, String state,
                  double amount, String cheqFacil, String accountType, String status) {
